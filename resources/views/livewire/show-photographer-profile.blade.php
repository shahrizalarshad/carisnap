                    ...
                    @foreach($profile->portfolioItems as $item)
                        ...
                        @if($media)
                            <div class="swiper-slide h-full">
                                <img src="{{ $media->getUrl('display') }}" alt="{{ $item->caption }}" class="w-full h-full object-cover" loading="lazy">
                            </div>
                        @endif
                    @endforeach
                </div>
    ...
    <div class="space-y-4">
        <div class="flex justify-between items-start">
            ...
            <div class="hidden sm:flex items-center gap-3">
                ...
                <x-ui.button variant="primary" size="lg" x-data x-on:click="$dispatch('open-booking-modal')">Hantar Booking Request</x-ui.button>
            </div>
        </div>
